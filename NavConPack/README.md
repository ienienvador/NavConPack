...
> **Note sur le PS Button** : Le bouton central PlayStation ouvre le Game Bar Windows (capture d'écran, enregistrement). Il ne peut pas être remappé en touche clavier car Windows l'intercepte au niveau du système. Pour désactiver ce comportement : Paramètres → Jeux → Game Bar → Désactiver.
