...
NOTE SUR LE PS BUTTON
---------------------
Le bouton central PlayStation (PS Button) ouvre le Game Bar Windows.
Il ne peut pas être remappé en touche clavier car Windows l'intercepte
au niveau du système. C'est une limitation de ScpToolkit/XInput.

Pour désactiver le Game Bar :
  Paramètres → Jeux → Game Bar → Désactiver
